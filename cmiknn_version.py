...
dat = pd.read_csv('/home/gnicolaou/tigramite/tutorials/causal_discovery/sim_data.csv')
dat = dat.values
n_a_n = np.isnan(dat).any(axis=1)
dat[n_a_n] = 999
...
pcmci_cmi = LPCMCI(
    ...
    verbosity=1)
results = pcmci_cmi.run_lpcmci(tau_max=2, pc_alpha = .01, link_assumptions = link_assumptions)
print(results)
